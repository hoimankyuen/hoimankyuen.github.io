export let data = 
{
    id: "clubgrenade",
    name: "Club Grenade",
    icon: "/data/clubgrenade/icon.png",
    platforms: [
        "windows"
    ],
    descriptions: [
    ...
    accomplishments: [
        "Directed and led the whole project, guided and mentored members with zero experience throughout the whole development process.",
        "Created various shader including cel-shading toon shader and force field shader.",
        "Designed and created most 2D and 3D assets using Photoshop and Blender.",
        "Designed structure and events of the entire level.",
        "Implemented input mode auto detection system to facilitate quick multiplayer joining."
    ],
    videos: [
